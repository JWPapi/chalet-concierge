...
export default function WhatsAppButton({ message }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-20 right-4 z-40 bg-green-500 text-white px-6 py-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 flex items-center gap-2 ${
